   ...
   <body class="home">
      ...
      <!-- <section class="content-block banner kents-well">
         ...
         <nav>
            <span class="nav-desktop">
               <a id="about-us" href="about-us.php">
               About <span>Us</span>
               </a>
      ...
      <section class="content-block every-child">
         ...
         <div class="paypalButton">
            <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
               ...
               <input type="hidden" name="item_name" value="">
               <input type="hidden" name="no_note" value="0">
               <input id="paypal-message" type="hidden" name="item_name" value="Thank you for making a child's dream in Haiti come true!">
				   <!-- <input type="hidden" name="amount" value="250.00"> -->
               <input type="hidden" name="currency_code" value="USD">
               <input type="image" src="images/donate.png" border="0" width="" name="submit" alt="PayPal - The safer, easier way to pay online!" title="DONATE">
               <img alt="" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1">
      ...
      <div class="content-wrapper">
            ...
            <article>
               ...
               <div class="article-content">
                  ...
                  <div class="article-content-text">
                     <span class="article-content-text-large">300</span>
                     <span class="article-content-text-medium">Students</span>
                     <span class="article-content-text-medium-small">and adding</span>
                     <span class="article-content-text-small">more each year!</span>
                     <span class="article-content-text-featured">Now up to Grade 12</span>
                  </div>
               </div>
            </article>
         </section>
         <section class="content-block survive-and-thrive">
            <article>
               <h3>Our Children <strong>Survive and Thrive</strong></h3>
               <ul>
                  <li class="food">Students are fed two meals a day to combat malnutrition.</li>
                  <li class="medical">We provide free medical attention.</li>
                  <li class="community">Our school is a community founded on the ideals of safe development for children and high-quality learning without the threat of disruption.</li>
               </ul>
            </article>
         </section>
      </div>
         ...
         <section class="content-block history">
            <article>
               ...
               <p>
                  ...
                  <a href="https://www.27east.com/sag-harbor-express/sag-harbor-news/sag-harbor-education-news/pilot-returns-to-haiti-on-school-building-mission-2-2129085/" class="read-more">Read More</a>
               </p>
            </article>
         </section>
      </div>
